...
class MangaWorldSource(
    private val client: MangaWorldSourceClient,
) : MangaSource {

    override fun sourceId() = MangaSourceId.MANGAWORLD

    override fun sourceName() = "MangaWorld"

    override fun supportedLanguages(): Set<String> = setOf("it")
