...
data class KomfConfig(
    ...
    val download: DownloadConfigDto,
    val autoDownloader: AutoDownloaderConfigDto,
    val envLocks: EnvLocksDto,
)

@Serializable
data class SchedulerConfigDto(
    val autoMatchEnabled: Boolean,
    val autoMatchIntervalHours: Int,
)
...
@Serializable
data class AutoDownloaderConfigDto(
    val enabled: Boolean,
    val intervalHours: Int,
    val notifyOnNewChapters: Boolean,
)

@Serializable
data class EnvLocksDto(
    val komgaBaseUri: Boolean,
    val komgaUser: Boolean,
    val komgaPassword: Boolean,
    val serverPort: Boolean,
    val logLevel: Boolean,
    val discordWebhooks: Boolean,
    val appriseUrls: Boolean,
    val malClientId: Boolean,
    val comicVineApiKey: Boolean,
    val comicVineSearchLimit: Boolean,
    val bangumiToken: Boolean,
    val downloadDir: Boolean = false,
    val downloadCbzCompression: Boolean = false,
    val downloadConcurrentPages: Boolean = false,
    val downloadAutoScan: Boolean = false,
    val autoDownloaderEnabled: Boolean = false,
    val autoDownloaderInterval: Boolean = false,
    val schedulerAutoMatchEnabled: Boolean = false,
    val schedulerAutoMatchInterval: Boolean = false,
)
