...
data class KomfConfigUpdateRequest(
    ...
    val scheduler: PatchValue<SchedulerConfigUpdateRequest> = PatchValue.Unset,
    val download: PatchValue<DownloadConfigUpdateRequest> = PatchValue.Unset,
    val autoDownloader: PatchValue<AutoDownloaderConfigUpdateRequest> = PatchValue.Unset,
)
...
data class SchedulerConfigUpdateRequest(
    val autoMatchEnabled: PatchValue<Boolean> = PatchValue.Unset,
    val autoMatchIntervalHours: PatchValue<Int> = PatchValue.Unset,
)

@Serializable
data class DownloadConfigUpdateRequest(
    val downloadDir: PatchValue<String> = PatchValue.Unset,
    val komgaLibraryId: PatchValue<String?> = PatchValue.Unset,
    val komgaLibraryPath: PatchValue<String?> = PatchValue.Unset,
...
@Serializable
data class AutoDownloaderConfigUpdateRequest(
    val enabled: PatchValue<Boolean> = PatchValue.Unset,
    val intervalHours: PatchValue<Int> = PatchValue.Unset,
    val notifyOnNewChapters: PatchValue<Boolean> = PatchValue.Unset,
)
